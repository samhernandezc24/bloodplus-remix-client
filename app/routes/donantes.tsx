import {NavbarDonantes} from '~/components/layout/navbar'
        ...
        <div className="container mx-auto flex flex-col flex-wrap items-center px-3 md:flex-row">
          ...
          <div className="w-full py-6 text-center md:w-3/5">
            <img
              ...
              src="/assets/images/bloodplus5.png"
            />
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-5/6 p-6 sm:w-1/2">
              ...
              <p className="mb-8 text-gray-600">
                El acceso a sangre y hemoderivados seguros es esencial para la
                cobertura sanitaria universal y es uno de los elementos
                fundamentales de los sistemas de salud eficaces.
              </p>
            </div>
          </div>
          <div className="flex flex-col-reverse flex-wrap sm:flex-row">
            <div className="mt-6 w-full p-6 sm:w-1/2">
              <div className="align-middle">
                ...
                <p className="mb-8 text-gray-600">
                  Es necesario realizar donaciones de sangre con regularidad en
                  todo el mundo para que las personas y las comunidades tengan
                  acceso a sangre y hemoderivados seguros y de calidad
                  garantizada.
                </p>
              </div>
            </div>
