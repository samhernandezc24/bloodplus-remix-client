      ...
      >
        <div className="p-4 text-center md:p-12 lg:text-left">
          ...
          <p className="flex items-center justify-center pt-4 text-base lg:justify-start">
            <svg
              className="h-4 fill-current pr-4 text-link"
          ...
          <div className="flex justify-between pb-8 pt-12">
            <button className="hover:bg-ring-link rounded-full bg-link px-4 py-2 font-bold text-white">
              Actualizar
            </button>
            <form action="/logout" method="post" className="m-0 p-0">
              <button
                type="submit"
                className="hover:bg-ring-link rounded-full bg-secondary px-4 py-2 font-bold text-white"
              >
                Cerrar sesión
              </button>
            </form>
